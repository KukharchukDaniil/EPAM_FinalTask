...
public class CourseDao extends AbstractDao<Course> {
    ...
    private static final String INSERT_COURSE = "INSERT INTO COURSES(COURSE_NAME,COURSE_DESCRIPTION,COURSE_CATEGORY,COURSE_IMAGE) VALUES(?, ?, ?, ?)";
    ...
    public Boolean isUserEnrolled(long userId, long courseId) throws DaoException {
        RowMapper<Course> mapper = new RowMapper<Course>() {
            ...
            public Course map(ResultSet resultSet) throws SQLException {
                return new Course(resultSet.getLong(1),null,null,null, null);
            }
        };
