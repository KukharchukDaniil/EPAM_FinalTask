...
public class CommandTypes {
    ...
    public static final String SHOW_CREATE_COURSE = "showCreateCoursePage";
    public static final String CREATE_COURSE = "createCourse";
    public static final String MANAGE_COURSE = "manageCourse";
    public static final String SHOW_MANAGE_COURSE = "showManageCourse";
