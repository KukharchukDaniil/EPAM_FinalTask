    ...
    <div class="main-contents">
        <div class="menu">
            ...
            <c:if test="${user.role == UserRole.TEACHER}">
                <a class="menu-button" onclick="openTab(event, 'Solutions')" id="defaultOpen"><fmt:message
                        key="label.solutions"/></a>
                <a class="menu-button"
                   href="${pageContext.request.contextPath}/controller?command=showCourse&courseId=${course.id}"><fmt:message
                        key="label.tasks"/></a>
            </c:if>
        </div>
        <div class="contents">
                ...
                <div class="wrapper">
                    <div class="table">
                        ...
                        <div class="row header blue">
                            ...
                            <div class="cell"><fmt:message key="label.status"/></div>
                            <div class="cell"><fmt:message key="label.mark"/></div>
